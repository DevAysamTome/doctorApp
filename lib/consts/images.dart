class AppAssets {
  static String icBody = "assets/icons/ic_body.png",
      ...
      icTooth = "assets/icons/dentist.png",
      icLogin = "assets/images/img_login.png",
      imgSignup = "assets/images/signupBG.png",
      imgWelcome = "assets/images/img_welcome.png",
      wscreen = "assets/images/wscreen2.jpg",
      imgDoctor = "assets/images/doctor.png",
      otpVerfication = "assets/images/otp.jpg",
      otpscreen1 = "assets/images/screen1.jpg",
      otpscreen2 = "assets/images/screen2.jpg",
      babyDoc = "assets/icons/Pediatrician.png",
      nervesDoc = "assets/icons/Nerves.png";
}
